...
export class DetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pagetitle=this.product.LastName;
    this.product1 =this.enrollments.find(p2 => p2.StudentID == this.id)
    this.product2 = this.courses.find(p3 => p3.CourseID == this.product1.CourseID)
